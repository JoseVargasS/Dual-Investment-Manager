...
def detect_domain(query):
    ...
    domain_keywords = {
        ...
        "product": ["saas", "ecommerce", "fintech", "healthcare", "dashboard", "portfolio"],
        "style": ["style", "design", "ui", "minimalism", "glassmorphism", "dark mode", "prompt"],
        "ux": ["ux", "usability", "accessibility", "wcag", "touch", "scroll", "animation"],
        "typography": ["font", "typography", "pairing", "heading", "typeface"],
        "google-fonts": ["google font", "font family", "find font", "monospace", "serif", "sans"],
        "icons": ["icon", "lucide", "heroicons", "svg icon"],
        "react": ["react", "next", "suspense", "memo", "rerender", "bundle"],
        "web": ["aria", "focus", "semantic", "autocomplete", "input type"],
    }
